...
//            connections[connection.identity] = connection;
        ...
        login: function (connection, collection, values, cb) {
            ...
            parse.loginUser(values['username'], values['password'],
        ...
        findUser: function (connection, collection, values, cb) {
            /* objectId, createdAt and UpdatedAt are Parse preserved words. */
            if (values.objectId == undefined) delete values.objectId;
        ...
        getUser: function (connection, collection, values, cb) {
            /* objectId, createdAt and UpdatedAt are Parse preserved words. */
            if (values.objectId == undefined) delete values.objectId;
            if (values.password != undefined) delete values.password;
            if (values.createdAt != undefined) delete values.createdAt;
        ...
        destroy: function (connection, collection, values, cb) {
            ...
            values.where = idToObjectId(values.where);

            var parse = grabConnection(connection);
            parse.deleteObject(collection, values.where.objectId, function (err, res, body, success) {
                if (err) return cb(false);
                if (!success) return cb(body.error);
