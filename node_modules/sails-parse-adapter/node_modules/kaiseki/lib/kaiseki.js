...
Kaiseki.prototype = {
  ...
  loginUser: function(username, password, callback) {
    var encondeUsername = encodeURIComponent(username);
    var encondePassword = encodeURIComponent(password);
    this._jsonRequest({
      url: '/1/login',
      params: {
        username: encondeUsername,
  ...
  getUsers: function(params, callback) {
    if(params) var where = '?where='+JSON.stringify(params);
    else var where = '';
